...
<head>
    ...
    <noscript>
        <link rel="stylesheet" href="<c:url value="/assets/js/vendor/file-upload/css/jquery.fileupload-noscript.css"/>">
    </noscript>
    <noscript>
        <link rel="stylesheet" href="<c:url value="/assets/js/vendor/file-upload/css/jquery.fileupload-ui-noscript.css"/>">
    </noscript>
            ...
            <div class="pageheader">
                ...
                <div class="page-bar">
                    ...
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <a href="form-validate.html">View Box</a>
                        </li>
                    </ul>
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-body">
                            ...
                            <form>
                                ...
                                <div class="form-group">
                                    <label>id: ${requestScope.Box.id}</label>
                                </div>
                                <div class="form-group">
                                    <label>Name: ${requestScope.Box.name}</label>
                                </div>
                                <div class="form-group">
                                    <label>Price: ${requestScope.Box.price} </label>
                                </div>

                                <div class="form-group">
                                    <label>Describe: ${requestScope.Box.description} </label>
                                </div>

                                <button type="button" class="btn btn-success" id="form1Submit" onclick="find(${requestScope.Box.id})">UPDATE</button>
                            </form>
...
<script>
    function find(id)
    {
        window.location = "/updateba/findBoxAdminEdit.do?id="+id;
    }
</script>
</body>
