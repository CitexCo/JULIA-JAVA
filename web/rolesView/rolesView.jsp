            ...
            <div class="pageheader">
                ...
                <div class="page-bar">
                    ...
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <a href="ui-buttons-icons.html"> View Roles</a>
                        </li>
                    </ul>
                ...
                <div class="col-md-6">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-body">
                            ...
                            <div class="row">
                                <form action="/roleua/addRoles.do">
                                    <input hidden="hidden" name="email" value="${requestScope.email}">
                                    <!-- Single button -->
                                    <div class="form-group col-md-12">
                                        <label class="col-sm-3 control-label">Roles</label>
                                        <div class="col-sm-10">
                                            <select name="role" tabindex="3" class="chosen-select" style="width: 240px;">
                                                <optgroup label="Roles">
                                                    <c:forEach items="${requestScope.rolesNames}" var="roles">
                                                        <option name="role" value="${roles.name}">
                                                                ${roles.name}
                                                        </option>
                                                    </c:forEach>
                                                </optgroup>
                            ...
                            <form action="/roleua/removeRoles.do" class="tagform">
                                <input hidden="hidden" name="email" value="${requestScope.email}">
                                <c:forEach items="${requestScope.userRoles}" var="userRoles">
                                    <button name="role_name" value="${userRoles.role_name}" class="tag"><i class="fa fa-times"></i>${userRoles.role_name}</button>
                                </c:forEach>
                            </form>
