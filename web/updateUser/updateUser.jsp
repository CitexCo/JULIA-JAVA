...
<head>
    ...
    <link rel="icon" type="image/ico" href="<c:url value="/assets/images/favicon.ico" />">
                ...
                <div class="col-md-6">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>Update</strong> User</h1>
                        ...
                        <div class="tile-body">
                            ...
                            <form action="/updateua/updateUser.do">
                                <div class="form-group">
                                    <label >ID: ${requestScope.User.id}</label>
                                    <input class="form-control" type="hidden" name="id" value="${requestScope.User.id}">
                                </div>
                                <div class="form-group">
                                    <label >Register Date: ${requestScope.User.regDate}</label>
                                    <input class="form-control" type="hidden" name="regDate" value="${requestScope.User.regDate}">
                                </div>
                                <div class="form-group">
                                    <label >Activity: </label>
                                    <select name="activity">
                                        <c:if test="${requestScope.User.activity eq false}">
                                            <option name="activity" value="true">Active</option>
                                            <option name="activity" value="false" selected>deActive</option>
                                        </c:if>
                                        <c:if test="${requestScope.User.activity eq true}">
                                            <option name="activity" value="true" selected>Active</option>
                                            <option name="activity" value="false">deActive</option>
                                        </c:if>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label >First Name:  </label>
                                    <input class="form-control" maxlength="20" type="text" name="firstName" value="${requestScope.User.firstName}" required>
                                </div>
                                <div class="form-group">
                                    <label >Last Name: </label>
                                    <input class="form-control" maxlength="20" type="text" name="lastName" value="${requestScope.User.lastName}" required>

                                </div>
                                <div class="form-group">
                                    <label >Email: </label>
                                    <input class="form-control" maxlength="20" type="email" name="email" value="${requestScope.User.email}" required>

                                </div>
                                <div class="form-group">
                                    <label >Password: </label>
                                    <input class="form-control" maxlength="20" type="password" name="password" value="${requestScope.User.password}" required>
                                </div>
                                    <input type="hidden" name="image" value="${requestScope.User.image}" readonly/>
