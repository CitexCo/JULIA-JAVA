                ...
                <div class="col-md-6">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-body">
                            ...
                            <form action="/updateba/updateBox.do">
                                <div class="form-group">
                                    <label >ID: ${requestScope.Box.id}</label>
                                    <input class="form-control" type="hidden" name="id" value="${requestScope.Box.id}">
                                </div>
                                <div class="form-group">
                                    <label>Name: </label>
                                    <input class="form-control" type="text" maxlength="20" name="name" value="${requestScope.Box.name}" required>

                                </div>
                                <div class="form-group">
                                    <label>Price: </label>
                                    <input class="form-control" type="text" name="price" value="${requestScope.Box.price}" required>

                                </div>
                                <div class="form-group">
                                    <label>Describe: </label>
                                    <input class="form-control" type="text" name="description" value="${requestScope.Box.description}" required>
