                                ...
                                <ul id="navigation">
                                    ...
                                    <li class="active open">
                                        ...
                                        <ul>
                                            ...
                                            <li class="active"><a href="tables-footable.html"><i class="fa fa-caret-right"></i> FooTable</a></li>
                                        </ul>
                                    </li>
                                    <li>
    ...
    <section id="content">
        ...
        <div class="page page-tables-footable">
            ...
            <div class="pageheader">
                ...
                <h2>FooTable <span>// You can place subtitle here</span></h2>
                            ...
                            <table id="searchTextResults" data-filter="#filter" data-page-size="10" class="footable table table-custom">
                                ...
                                <c:forEach items="${requestScope.Boxes}" var="box">
                                    <tr>
                                        ...
                                        <td><input type="button" name="id" value="view" onclick="find('${box.id}')">
...
<script>
    function find(id)
    {
        window.location = "/viewba/findBox.do?id="+id
    }
</script>
