...
public class SendEmail {
    ...
    /*send verify for email*/
    @RequestMapping(value = "registerEmail.do")
    public String sendEmail(HttpServletRequest request, String email ) throws MessagingException {
    ...
    public void sessionCode(HttpServletRequest request)
    {
